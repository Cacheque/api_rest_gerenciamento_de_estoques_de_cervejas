...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Gariano Cacheque";
    private static final String CONTACT_GITHUB = "https://gtihub.com/Cacheque";
    private static final String CONTACT_EMAIL = "galiano09_cacheque@outlook.com";
